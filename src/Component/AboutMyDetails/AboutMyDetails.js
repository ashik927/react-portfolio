  ...
  return (
    <div style={{ marginTop: "60px", backgroundImage: `linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(${animation})` }}>
      ...
      <div className="container">
        ...
        <h5 className="text-center text-white pb-5 pt-5">Design & Created by <span style={{ color: 'rgb(81, 233, 157)' }}>Khandker Ashik Mahmud</span></h5>
      </div>
    </div>
  );
};
